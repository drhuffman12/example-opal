...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$reduce', '$map', '$*', '$puts', '$sum_of_cubes', '$attr_reader', '$canvas_id', '$canvas', '$floor', '$/', '$height', '$width', '$>=', '$context', '$+', '$fill_cell', '$-', '$new', '$draw_canvas']);
  self.$require("opal");
...
if (n == null) n = nil;
  ...
  (function($base, $super) {
    ...
    return (Opal.defn(self, '$unfill_cell', function(x, y) {
      var self = this;
