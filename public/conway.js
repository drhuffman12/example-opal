...
if (n == null) n = nil;
  ...
  (function($base, $super) {
    ...
    return nil;
  })($scope.base, $scope.get('OpenStruct'));
  (function($base, $super) {
    function $Grid(){};
...
if (q == null) q = nil;
    ...
    Opal.defn(self, '$get_cursor_position', function(event) {
      ...
      x = $rb_minus(x, self.$canvas().offsetLeft);
      y = $rb_minus(y, self.$canvas().offsetTop);
      x = ($rb_divide(x, $scope.get('CELL_WIDTH'))).$floor();
      y = ($rb_divide(y, $scope.get('CELL_HEIGHT'))).$floor();
